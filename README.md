...
| [Object Oriented Design - University of Alberta](https://www.coursera.org/learn/object-oriented-design), [Object Oriented Analysis & Design - Tutorials Point](https://www.tutorialspoint.com/object_oriented_analysis_design/index.htm), [NPTEL OOAD](https://nptel.ac.in/courses/106105153)| `object-oriented`: (`object-oriented analysis`, `object-oriented design`, `OOP`) <br>`OOP`: (`UML`, class: {function types: {constructor, destructor, iterator, getter, setter}, design by contract}, object: {relations/links: {association, aggregation}, visibility, synchronization}) | Was no any |
